...
public:
    ...
    bool scopetable_insert(SymbolInfo* sinfo)
    {
        ...
        if(hash_table[position] != nullptr)
        {
            ...
            if(head->getName() == tem_name)
            {
                ...
                os << "< " <<tem_name << ", " << sinfo->getType() <<" > already exists in current ScopeTable\n";
                return false;
            }
            ...
            os << "Inserted in ScopeTable# " << table_id << " at position " << position << ", " << chain_position << endl;
            return true;
            ...
            os << "Inserted in ScopeTable# " << table_id << " at position " << position << ", 0" << endl;
    ...
    SymbolInfo* scope_lookup(string n)
    {
        ...
        if(hash_table[position] == nullptr)
        {
            ...
            if(head->getName() == n)
            {
                ...
                os << "Found in ScopeTable# " << table_id << " at position " << position << ", 0\n";
                return head;
            }
            ...
            while(head->getNextSymbol() != nullptr)
            {
                ...
                if(head->getName() == n){
                    ...
                    os << "Found in ScopeTable# " << table_id << " at position " << position << ", " << chain_position << endl;
                    return head;
                }
    ...
    bool scope_delete(string n)
    {
        ...
        if(head->getName() == n){
            ...
            os << "Deleted Entry " << position << ", 0 from current ScopeTable\n";
            return true;
        }
            ...
            while(head->getNextSymbol() != nullptr)
            {
                ...
                if(tem_symbol->getName() == n){
                    ...
                    os << "Deleted Entry " << position << ", " << chain_position << " from current ScopeTable\n";
                    return true;
                }
                head = head->getNextSymbol();
            }
...
public:
    ...
    void EnterScope(){
            ...
            os << "New ScopeTable with id " << currentScope->getid() << " created\n";
            scope_deleted = 0;
    ...
    void ExitScope(){
        ...
        os << "ScopeTable with id " << currentScope->getid() << " removed\n";
        delete currentScope;
        currentScope = temp;
